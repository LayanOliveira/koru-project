...
// Desafio: Verifique se o nome completo contém a letra "a"
const letra = "a";
const contemLetra = fullName.toLowerCase().includes(letra);
console.log(`O nome completo contém a letra "${letra}"?`, contemLetra);
